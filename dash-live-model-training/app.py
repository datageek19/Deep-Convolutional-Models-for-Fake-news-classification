...
app.layout = html.Div([
    ...
    html.Div([
        html.H2(
            'Deep Convolutional models for fake news analysis - Live Tracker',
            id='title'
        ),
        html.Img(
        ...
        *demo_components(demo_mode),
        ...
        html.Div([
            dcc.Dropdown(
                ...
                options=[
                    {'label': 'State of art CNN model', 'value': 'no'},
                    {'label': 'Hybrid CNN model', 'value': 'slow'},
                    {'label': 'State of art C-LSTM model', 'value': 'slow'},
                    {'label': 'Optimal C-LSTM model', 'value': 'regular'},
                    {'label': 'Recurrent CNN (RCNN) model', 'value': 'fast'}
                ],
                value='regular',
                className='ten columns',
                clearable=False,
